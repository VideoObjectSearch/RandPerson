...
well to unseen target images, surpassing the models trained on various real-world datasets, including CUHK03, Market-1501, DukeMTMC-reID, and MSMT17. The experimental results are shown in the following tables.
