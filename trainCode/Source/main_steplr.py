...
def get_data(dataname, data_dir, height, width, batch_size, combine_all=False,
                 min_size=0.2, max_size=1.0, workers=8, test_batch=2048):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_fea_batch', type=int, default=2048, help="Feature extraction batch size during testing. "
                                                                     "Reduce this if you encounter a gpu memory overflow.")
    parser.add_argument('--test_ker_batch', type=int, default=4096, help="QAConv kernel batch size during testing. Reduce this "
                                                                     "if you encounter a gpu memory overflow.")
    parser.add_argument('--test_prob_batch', type=int, default=16, help="QAConv probe batch size during testing. Reduce this "
                                                                     "if you encounter a gpu memory overflow.")
